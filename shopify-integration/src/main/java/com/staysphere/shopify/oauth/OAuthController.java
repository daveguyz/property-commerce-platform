package com.staysphere.shopify.oauth;

import com.staysphere.shopify.model.ShopifyStoreToken;
import com.staysphere.shopify.repository.ShopifyStoreTokenRepository;
import com.staysphere.shopify.service.ThemeProvisioningService;
        ...
        for (String topic : topics) {
            try {
                Map<String, Object> webhook = Map.of(
                        "topic",   topic,
                        "address", frontendUrl.replace("https://staysphere-aos.myshopify.com",
                                System.getenv().getOrDefault("APP_PUBLIC_URL",
                                        "https://app.staysphere.com"))
