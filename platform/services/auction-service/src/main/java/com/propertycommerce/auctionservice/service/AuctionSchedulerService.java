...
import com.propertycommerce.shared.events.AuctionLotOpenedEvent;
...
public class AuctionSchedulerService {
    ...
    public void dailyIndexRefresh() {
        long scheduled = lotRepository.countByStatus(
                com.propertycommerce.auctionservice.model.AuctionLotStatus.SCHEDULED);
        long open = lotRepository.countByStatus(
                com.propertycommerce.auctionservice.model.AuctionLotStatus.OPEN);
    ...
    public void safetyCloseExtendedLots() {
        List<AuctionLot> extended = lotRepository.findAllLiveLots().stream()
                .filter(l -> l.getStatus() == com.propertycommerce.auctionservice.model.AuctionLotStatus.EXTENDED)
