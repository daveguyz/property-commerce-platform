...
import com.propertycommerce.auctionservice.model.Bid;
import com.propertycommerce.auctionservice.repository.BidRepository;
import com.propertycommerce.auctionservice.repository.BiddingCredentialRepository;
import com.propertycommerce.auctionservice.model.BiddingCredential;
import com.propertycommerce.auctionservice.model.CredentialStatus;
...
public class AiFraudService {
    ...
    private FraudAssessment callClaude(Bid bid, double rulesScore, String lotId, int totalBids) {
        String systemPrompt = """
                You are an auction fraud detection AI for Property Commerce, a Namibian property auction platform.
