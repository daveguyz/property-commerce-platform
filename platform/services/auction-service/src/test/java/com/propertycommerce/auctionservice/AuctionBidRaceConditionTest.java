...
import com.propertycommerce.auctionservice.service.BidEngineService;
...
class AuctionBidRaceConditionTest {
    ...
    @MockBean com.propertycommerce.auctionservice.websocket.AuctionBroadcastService broadcastService;
    @MockBean com.propertycommerce.auctionservice.service.AiFraudService aiFraudService;
    @MockBean com.propertycommerce.auctionservice.service.KycService kycService;
    ...
    void setup() {
        ...
        var cleanAssessment = new com.propertycommerce.auctionservice.service.AiFraudService.FraudAssessment(0.0, "clean", false);
