package com.propertycommerce.paymentservice.service;
import com.stripe.*;
...
import com.propertycommerce.paymentservice.model.*;
import com.propertycommerce.paymentservice.repository.*;
...
public class StripePaymentService {
    ...
    public Map<String, String> createHostConnectAccount(String hostId, String email, String country) throws StripeException {
        ...
        AccountLinkCreateParams linkParams = AccountLinkCreateParams.builder()
                ...
                .setRefreshUrl("https://propertycommerce.io.com/host/stripe/refresh")
                .setReturnUrl("https://propertycommerce.io.com/host/stripe/complete")
