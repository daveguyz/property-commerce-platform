package com.propertycommerce.notificationservice.listener;

import com.propertycommerce.notificationservice.service.EmailService;
        ...
        try {
            ...
            if (event.getUserEmail() != null) {
                emailService.sendEmail(
                    ...
                    vars, com.propertycommerce.notificationservice.model.NotificationLog.NotificationType.ACCOUNT_VERIFIED
                );
