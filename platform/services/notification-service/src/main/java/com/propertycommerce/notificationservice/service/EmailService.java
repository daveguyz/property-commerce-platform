package com.propertycommerce.notificationservice.service;

import com.propertycommerce.notificationservice.model.NotificationLog;
import com.propertycommerce.notificationservice.repository.NotificationLogRepository;
...
public class EmailService {
    ...
    @Value("${spring.mail.from:noreply@propertycommerce.io}") private String fromEmail;
    @Value("${pcp.brand.name:Property Commerce}") private String brandName;
    ...
    public void sendBookingConfirmation(String to, String userId, String bookingId,
        ...
        sendEmail(to, userId, bookingId, "booking-confirmation",
                "Your Property Commerce Booking is Confirmed!", templateVars,
    ...
    public void sendBookingCancellation(String to, String userId, String bookingId,
        ...
        sendEmail(to, userId, bookingId, "booking-cancellation",
                "Your Property Commerce Booking Has Been Cancelled", templateVars,
    ...
    public void sendWelcomeEmail(String to, String userId, Map<String, Object> templateVars) {
        sendEmail(to, userId, null, "welcome",
                "Welcome to Property Commerce — Your Namibian Home Away From Home", templateVars,
