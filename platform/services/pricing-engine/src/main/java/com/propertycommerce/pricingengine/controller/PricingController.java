package com.propertycommerce.pricingengine.controller;
import com.propertycommerce.pricingengine.service.DynamicPricingService;
...
public class PricingController {
    ...
    public ResponseEntity<ApiResponse<DynamicPricingService.PricingRecommendation>> recalculate(
        ...
        var result = pricingService.recalculatePropertyPrice(
                com.propertycommerce.shared.dto.PropertyDTO.builder().id(propertyId).build());
