...
import com.propertycommerce.propertyservice.model.Property;
...
public class ShopifyProductSyncService {
    ...
    private List<Map<String, String>> buildMetafields(Property property) {
        return List.of(
            Map.of("namespace","pcp","key","property_id","value",property.getId(),"type","single_line_text_field"),
            Map.of("namespace","pcp","key","bedrooms","value",String.valueOf(property.getBedrooms()),"type","number_integer"),
            Map.of("namespace","pcp","key","max_guests","value",String.valueOf(property.getMaxGuests()),"type","number_integer"),
            Map.of("namespace","pcp","key","city","value",property.getLocation().getCity(),"type","single_line_text_field"),
            Map.of("namespace","pcp","key","latitude","value",String.valueOf(property.getLocation().getLatitude()),"type","single_line_text_field"),
            Map.of("namespace","pcp","key","longitude","value",String.valueOf(property.getLocation().getLongitude()),"type","single_line_text_field"));
    }
