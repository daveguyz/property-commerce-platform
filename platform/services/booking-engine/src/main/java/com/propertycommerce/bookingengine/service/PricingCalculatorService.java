...
public class PricingCalculatorService {
    @Value("${pcp.platform.service-fee-percent:10}") private double serviceFeePercent;
    @Value("${pcp.platform.tax-percent:15}") private double taxPercent;
    @Value("${pcp.platform.host-payout-percent:97}") private double hostPayoutPercent;
