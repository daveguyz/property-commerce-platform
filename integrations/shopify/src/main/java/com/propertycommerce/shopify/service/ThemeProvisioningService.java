package com.propertycommerce.shopify.service;
...
/**
 * ThemeProvisioningService — pushes the Property Commerce Shopify theme
 * to a merchant's store via the Shopify Admin Assets API when they
 * install the Property Commerce Platform app.
 *
 * Flow:
 *   1. Create a new theme on the store ("Property Commerce Platform")
...
public class ThemeProvisioningService {
    ...
    @Value("${pcp.app.name:Property Commerce Platform}")  private String appName;
    @Value("${pcp.app.api-gateway-url:}")     private String defaultApiGatewayUrl;
     ...
     *
     * @param shopDomain   e.g. "propertycommerce.io"
     ...
     * Used when the merchant updates to a new version of Property Commerce Platform.
     */
